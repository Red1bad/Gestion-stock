...
@section('content')
    ...
    <div class="d-flex justify-content-center gap-3">
        ...
        <a href="/products-category" class="btn btn-warning btn-lg shadow-sm">Products by Category</a>
        <a href="/products-supplier" class="btn btn-secondary btn-lg shadow-sm">Products by Supplier</a>
        <a href="/products-store" class="btn btn-dark btn-lg shadow-sm">Products by Store</a>
